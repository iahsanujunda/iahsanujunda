...
- 🐝 I have worked on several side projects on a web development using MERN stack that is deployed to Heroku. At work, I extensively use FastAPI, and other python data stack.
